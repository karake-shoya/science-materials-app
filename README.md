...
### 1. 電気回路図のエディタ
![editor画面のスクリーンショット](./public/screenshots/editor-visual.png) 
直感的な操作で複雑な回路図を簡単に作成でき、PDFや画像として書き出してそのまま教材に活用できます。
...
理科の計算単元に対応し、一問一答から応用問題まで、パラメーターを調整して問題プリントを生成できます。
