  ...
  generate(count: number): QuestionData[] {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      if (qType === 1) {
        ...
        qText1 = `問${i}. $100m$ 走で、${distM}m を ${timeS}秒間で走った人の平均の速さは何m/sですか。`;
        qText2 = "計算して答えなさい。";
        ...
        qText1 = `問${i}. 時速 ${speedKmh}km の速さで走る乗り物が ${timeH}時間移動しました。`;
        qText2 = "このとき移動した距離は何kmですか。";
        ...
        qText1 = `問${i}. 秒速 ${speedMs}m の速さで走る人が ${distM}m 移動しました。`;
        qText2 = "移動にかかった時間は何分何秒ですか。";
