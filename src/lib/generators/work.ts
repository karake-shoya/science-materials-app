  ...
  generate(count: number): QuestionData[] {
    ...
    for (let i = 1; i <= count; i++) {
      ...
      if (qType === 1) {
        ...
        qText1 = `問${i}. ${massG}g の物体を、地面から ${distM}m の高さまで垂直に持ち上げました。`;
        qText2 = "このときに人がした仕事は何Jですか。(100gの物体にはたらく重力の大きさを1Nとする)";
        ...
        qText1 = `問${i}. ${joule}J の仕事を ${seconds}秒間かけて行いました。`;
        qText2 = "このときの仕事率は何Wですか。";
        ...
        qText1 = `問${i}. 重さ ${massG}g の物体を、動滑車を使って ${distM}m 持ち上げました。`;
        qText2 = "このとき、ひもを引いた力の大きさは何Nですか。また仕事は何Jですか。(解答は N, J の順)";
        ans = `${forceN}, ${workJ}`;
